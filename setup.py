...
setup(
    ...
    extras_require={"mysql": ["mysqlclient"], "postgres": ["psycopg2"]},
    tests_require=[
        "cov-core>=1.15.0",
        "coverage>=3.7.1",
        "py>=1.4.29",
    ...
    setup_requires=["pytest-runner>=2.7,<3dev",],
    entry_points="""
    [console_scripts]
    ...
    download_url=(
        "https://github.com/odarbelaeze/condor-ir/tarball/{}".format(condor.__version__)
    ),
